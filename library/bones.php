...
function bones_scripts_and_styles() {
 ...
 codex/move-scripts-to-wp_enqueue_script-function
...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'top-nav' => __( 'The top Menu', 'bonestheme' ),   // top nav in header
            'cat-nav' => __( 'Practice Areas Menu', 'bonestheme' ),   // categories nav in header
			'footer-links-1' => __( 'Footer Links 1', 'bonestheme' ), // secondary nav in footer,
...
MENUS & NAVIGATION
*********************/
function aero_wp_nav_menu( $menu_id, $menu_class, $menu_name,  $container_id, $container_class) {
    // display the wp3 menu if available
    wp_nav_menu(array(
        'menu' => __( $menu_name, 'bonestheme' ),  // nav name
        'container_class' => $container_class,
        'container_id' =>  $container_id,
        'menu_class' => 'nav menu clearfix ' .$menu_class,         // adding custom nav class
        'theme_location' => $menu_id,                 // where it's located in the theme
